...
class Carla3d(BaseStereoViewDataset):
    def __init__(self,
        ...
        print('loading carla3d dataset...')
        super().__init__(*args, **kwargs)
        self.dataset_label = 'carla3d'
        self.split = dset
        ...
        self.sequences = []
        # Get all folders under dataset_location
        self.sequences = [os.path.join(dataset_location, seq) for seq in os.listdir(dataset_location)]
        
        if self.split == 'train':
            # Filter sequences that do not contain 'Town10HD_Opt' in seq_name
            self.sequences = [seq for seq in self.sequences if 'Town10HD_Opt' not in seq]
        elif self.split == 'test':
            # Filter sequences that contain 'Town10HD_Opt' in seq_name
            self.sequences = [seq for seq in self.sequences if 'Town10HD_Opt' in seq]
        ...
        intrinsics=[195.54, 195.54, 173, 130]
