...
class MVSEC(BaseStereoViewDataset):
    def __init__(self,
        ...
        if 'outdoor_day2' in dataset_location:
            TRAIN_RANGE = [17,8541]
            TEST_REANGE = [10368, 12194]
        elif 'indoor_flying1' in dataset_location:
            # TRAIN_RANGE = [139,1200]
            TEST_REANGE = [140,1200]
        elif 'indoor_flying2' in dataset_location:
            TRAIN_RANGE = [159,1580]
            # TEST_REANGE = [160,1580]
        elif 'indoor_flying3' in dataset_location:
            TRAIN_RANGE = [124,1816]
            # TEST_REANGE = [125,1815]
