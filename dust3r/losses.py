...
class ConfLoss (MultiLoss):
    ...
    def compute_loss(self, gt1, gt2, pred1, pred2, **kw):
        ...
        # if gt1['valid_mask'].sum() < 100:
        #     loss1 = (0.0 * pred1['pts3d']).mean()
        # if gt2['valid_mask'].sum() < 100:
        #     loss2 = (0.0 * pred2['pts3d_in_other_view']).mean()
        ...
        conf_loss1 = conf_loss1.mean() if conf_loss1.numel() > 0 else 0*pred1['pts3d'].mean()
        conf_loss2 = conf_loss2.mean() if conf_loss2.numel() > 0 else 0*pred2['pts3d_in_other_view'].mean()
